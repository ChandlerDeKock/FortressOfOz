public interface GameObject {
	...
	//This method is responsible for handling the interactions between the current GameObject and the object 
	//it is acting on. Example of such an interaction is a player attacking an enemy.
